...
typedef struct{
    float vida,mana,ataque,defesa;
    float vida_base,mana_base,ataque_base,defesa_base;
    int lv,classe,andar_max,grana;
    char nome[30];
    Inventario set;
}Personagem;
...
void aplicar_armagedon(Atributos_parciais* bruxo,Buff_Debuff* amaldicoado){
    ...
    (*amaldicoado).armagedon.itensidade=1;
    printf("\n\n\n AAAMAGEDON!");
}
...
void ataque_armagedon(Atributos_parciais* bruxo,Buff_Debuff* s_bruxo,Personagem* corpo_bruxo,Atributos_parciais* amaldicoado,Buff_Debuff* s_amaldicoado,Personagem* corpo_amaldicoado,float* dps, float* dano,int* rng){
    ...
    aplicar_armagedon(bruxo,s_amaldicoado);
    *rng=D20();
    *dps=dano_por_turnos(s_amaldicoado,bruxo,amaldicoado,corpo_amaldicoado,corpo_bruxo)+0.15*(*bruxo).vida;
    *dano=Dano_Total(rng,1,dps,(*amaldicoado).defesa);
     printf("\n %s causou um total de %.2f de dano a %s",bruxo->nome,(*dano)*-1,corpo_amaldicoado->nome);
...
int batalha(Cadastro *conta,Inimigo *alvo,int* personagem_atual){
    Personagem personagem_alvo,*heroi,*pinimigo;
    pinimigo=&personagem_alvo;
    heroi=&(*conta).heroi[*personagem_atual];
    Atributos_parciais status_heroi,status_inimigo;
    Buff_Debuff situacao_heroi,situacao_inimigo;
    int rng,escolha;
    float dano_primario=0,full_dano=0,custo;
    receber_valores_heroi(&status_heroi,heroi);
    receber_valores_inimigo(&status_inimigo,pinimigo,alvo);
    zerando_maldicoes(&situacao_heroi);
    zerando_maldicoes(&situacao_inimigo);
    while(1){
        system("cls");
        printar_interface(&status_heroi,&status_inimigo);
        scanf("%i",&escolha);
        efeito_atordoar(&situacao_heroi,heroi,&escolha);
        rng=D10();
        efeito_medo(&situacao_heroi,heroi,&rng);
        switch(escolha){
            case 1:{
                    switch(heroi->classe){
                            case 1:{ //lutador
                                ...
                                scanf("%i",&escolha);
                                efeito_silencio(&situacao_heroi,heroi,&escolha);
                                rng=D10();
                                switch(escolha){
                                        case 1:{
                                                if(rng>4){
                                                    ataque_basico(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                }
                                                else printf("\n\n\n ataque falhou");
                                                break;
                                        }
                                        case 2:{
                                                if(status_heroi.mana>=3){
                                                    status_heroi.mana-=3;
                                                    if(rng>=2){
                                                        ataque_em_cruz(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falhou");
                                                }
                                        ...
                                        case 3:{
                                                if(status_heroi.mana>10){
                                                    status_heroi.mana-=10;
                                                    if(rng>=2){
                                                        ataque_estocada(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("mana insuficiente\n\n\n");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                        ...
                                        case 4:{
                                                if(status_heroi.mana>=20){
                                                    status_heroi.mana-=20;
                                                    if(rng>=2){
                                                        ataque_corte_profundo(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("mana insuficiente\n\n\n");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                        ...
                                        default:{
                                                  ataque_falho(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                  break;
                                        }
                                }
                                break;
                            ...
                            case 2:{ //tank
                                printf("\n1-ataque basico\t 2-golpe de escudo('3')\n 3-provocar('10'\t 4-armagedon(*%.1f*)",0.2*heroi->vida);
                                scanf("%i",&escolha);
                                efeito_silencio(&situacao_heroi,heroi,&escolha);
                                if(escolha!=1){
                                    if(situacao_heroi.silencio.existencia==1){
                                        printf("\n\n\nnao é possivel usar habilides enquanto silenciado");
                                        break;
                                    }
                                }
                                rng-=situacao_heroi.medo.itensidade;
                                custo=0.2*heroi->vida;
                                switch(escolha){
                                        case 1:{
                                                if(rng>4){
                                                    ataque_basico(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                        ...
                                        case 2:{
                                                if(status_heroi.mana>=3){
                                                    status_heroi.mana-=3;
                                                    if(rng>2){
                                                       ataque_golpe_de_escudo(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falhou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                        ...
                                        case 3:{
                                                if(status_heroi.mana>15){
                                                    status_heroi.mana-=15;
                                                    if(rng>2){
                                                        ataque_provocar(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falhou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                        ...
                                        case 4:{
                                                if(status_heroi.vida>custo){
                                                    status_heroi.vida-=custo;
                                                    if(rng>2){
                                                        ataque_armagedon(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habildade falhou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                ...
                                switch(escolha){
                                        ...
                                        case 2:{
                                                if(status_heroi.mana>=3){
                                                    status_heroi.mana-=3;
                                                    if(rng>2){
                                                        ataque_bola_de_fogo(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                        ...
                                        case 3:{
                                                if(status_heroi.mana>10){
                                                    status_heroi.mana-=10;
                                                    if(rng>2){
                                                        ataque_venenoso(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falhou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                        ...
                                        case 4:{
                                                if(status_heroi.mana>=20){
                                                    status_heroi.mana-=20;
                                                    if(rng>2){
                                                        ataque_terremoto(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falhou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                            ...
                            case 4:{ //assassino
                                ...
                                switch(escolha){
                                        case 1:{
                                                if(rng>4){
                                                   ataque_basico_assassino(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                }
                                                else printf("ataque falhou\n\n\n");
                                                break;
                                        }
                                        case 2:{
                                                if(status_heroi.mana>=3){
                                                    status_heroi.mana-=3;
                                                    if(rng>2){
                                                        ataque_apunhalar(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falhou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                        ...
                                        case 3:{
                                                if(status_heroi.mana>10){
                                                    status_heroi.mana-=10;
                                                    if(rng>2){
                                                        ataque_dilacerar(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falhou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
                                        ...
                                        case 4:{
                                                if(status_heroi.mana>=20){
                                                    status_heroi.mana-=20;
                                                    if(rng>2){
                                                        ataque_golpe_na_garganta(&status_heroi,&situacao_heroi,heroi,&status_heroi,&situacao_inimigo,pinimigo,&dano_primario,&full_dano,&rng);
                                                    }
                                                    else printf("\n\n\n a habilidade falhou");
                                                }
                                                else printf("mana insuficiente\n\n\n");
        ...
        rng=0;
        efeito_atordoar(&situacao_inimigo,pinimigo,&rng);
        if(rng==0){
            contra_ataque(alvo,&status_inimigo,&situacao_inimigo,pinimigo,&status_heroi,&situacao_heroi,heroi,&dano_primario,&full_dano,&rng);
        }
        else{
            ataque_falho(&status_inimigo,&situacao_inimigo,pinimigo,&status_heroi,&situacao_heroi,heroi,&dano_primario,&full_dano,&rng);
...
int main()
{
    ...
    Inimigo inimigo;
    int x=0;
    user.heroi[x].defesa_base=0;
    inimigo.defesa=10;
    user.heroi[x].vida_base=inimigo.vida=100000;
    user.heroi[x].ataque_base=15;
    inimigo.ataque=500;
    user.heroi[x].mana=100;
    inimigo.tipo=8;
    printf("H");
    gets(user.heroi[0].nome);
    printf("\n\nI");
    gets(inimigo.nome);
    user.heroi[0].classe=1      ;
    x=batalha(&user,&inimigo,&x);
    if(x==1)printf("\n\n\n\n vitoria");
    else printf("\n\n\n\n derrota");
    getch();
    return 0;
